...
import { useGetAllBookingsQuery, useGetBookingsByUserQuery } from "@/features/bookings/api/booking.api";
...
export default function Booking() {
    ...
    const {data, isLoading, isError, refetch, isFetching} = useGetAllBookingsQuery();
